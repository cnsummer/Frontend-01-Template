 ...
 * @Version: 1.0
 * @Autor: slq
 * @Date: 2020-05-25 23:17:05
 * @LastEditors: slq
 * @LastEditTime: 2020-05-25 23:17:05
 */ 
...
function  happen (elemenet, event){
    return new Promise(function(resolve) {
        let handler = () =>{
            resolve()
            elemenet.removeEventListener(event, handler)
        }
        elemenet.addEventListener(event, resolve)
    })
}
